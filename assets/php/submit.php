...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['number']) && isset($_POST['comment'])){
	...
	$html="<table><tr><td>Name:</td><td>$name</td></tr><tr><td>Email:</td><td>$email</td></tr><tr><td>Number:</td><td>$number</td></tr><tr><td>Comment:</td><td>$comment</td></tr></table>";
	...
	$mail->Subject = "(LockWise) New Contact Info";
	$mail->Body = $html;
